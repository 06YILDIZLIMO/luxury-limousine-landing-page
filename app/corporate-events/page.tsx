      ...
      <section className="container mx-auto px-4 py-20 md:py-28">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
            Corporate <span className="text-yellow-400">Events</span>
          </h1>

          <p className="text-zinc-300 text-lg leading-relaxed mb-10 max-w-4xl">
            Professional chauffeur services for business meetings, conferences, and executive travel. Make a lasting
            impression on your clients and partners with our premium fleet. Confidential, reliable, and punctual service
          ...
          <div className="relative overflow-hidden rounded-xl shadow-2xl shadow-yellow-500/10 border border-yellow-500/20 mb-10">
            <Image
              src="/mercedes.webp"
              alt="A business professional working on a laptop in a luxury Mercedes S-Class"
              width={1600}
              height={900}
