      ...
      <section className="container mx-auto px-4 py-20 md:py-28">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
            Airport <span className="text-yellow-400">Transfers</span>
          </h1>

          <p className="text-zinc-300 text-lg leading-relaxed mb-10 max-w-4xl">
            Reliable and punctual airport transportation with flight tracking and meet-and-greet service. We monitor your
            flight status and adjust pickup times accordingly. Complimentary waiting time, luggage assistance, and
            professional service from door to terminal.
          </p>

          <div className="relative overflow-hidden rounded-xl shadow-2xl shadow-yellow-500/10 border border-yellow-500/20 mb-10">
            <Image
              src="/yukon.webp"
              alt="A professional chauffeur with a luxury SUV near Toronto Pearson Terminal 1"
              width={1600}
              height={900}
