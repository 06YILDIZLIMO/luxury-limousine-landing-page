      ...
      <section className="container mx-auto px-4 py-20 md:py-28">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
            Special <span className="text-yellow-400">Occasions</span>
          </h1>

          <p className="text-zinc-300 text-lg leading-relaxed mb-10 max-w-4xl">
            Celebrate birthdays, anniversaries, proms, bachelorette parties, and nights out in style and luxury.
            Create unforgettable memories with premium transportation for your special moments. VIP treatment guaranteed.
          </p>

          <div className="relative overflow-hidden rounded-xl shadow-2xl shadow-yellow-500/10 border border-yellow-500/20 mb-10">
            <Image
              src="/reward.webp"
              alt="Luxury limousine interior with champagne glasses and a stylish party group"
              width={1600}
              height={900}
