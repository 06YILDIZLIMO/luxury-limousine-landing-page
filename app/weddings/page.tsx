      ...
      <section className="container mx-auto px-4 py-20 md:py-28">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-zinc-300 text-lg leading-relaxed mb-10 max-w-4xl">
            Make your special day unforgettable with our elegant wedding limousine packages. From the bride&apos;s exit
            to transporting the wedding party, we ensure every moment is picture-perfect. Custom decorations and
          ...
          <div className="relative overflow-hidden rounded-xl shadow-2xl shadow-yellow-500/10 border border-yellow-500/20 mb-10">
            <Image
              src="/lincoln.webp"
              alt="Elegant wedding limousine setup with decorations and red carpet experience"
              width={1600}
              height={900}
